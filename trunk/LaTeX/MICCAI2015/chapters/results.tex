...
% subjects of our in-house data set to MNI space and calculated the average lesion
% mask. We used the square root of the average lesion mask as a prior to
% counterbalance large differences in lesion probability between regions and added
% the lesion prior as an additional input channel to both data sets.
%
...
% TODO: do something about the time. Why is the time so long for only 5 images?
...
\node[rotate=90,align=center] {CHB\,07\\(DSC\,=\,\SI{60.58}{\percent})}; &
...
\node[rotate=90,align=center] {CHB\,04\\(DSC\,=\,\SI{61.37}{\percent})}; &
...
\node[rotate=90,align=center] {UNC\,09\\(DSC\,=\,\SI{9.01}{\percent})}; &
