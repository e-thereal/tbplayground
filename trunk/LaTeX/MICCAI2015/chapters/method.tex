...
function $s$ that maps multi-modal images $I$, e.g., \todo{need a better way to
write this}$I = (I_\text{flair}, I_\text{t1}, I_\text{t2})$, to corresponding
...
follows\todo{This equation is almost
identical to equation (1) in \cite{zeiler2011}.
I've just added the sigmoid function because our output is binary.}
\begin{equation}
...
To train our model, we have to derive the derivatives of the modified objective
