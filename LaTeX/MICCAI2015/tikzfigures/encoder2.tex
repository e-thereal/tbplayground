...
\draw[decorate,decoration={brace,raise=15pt,mirror}] (C0) --
...
\draw[decorate,decoration={brace,raise=15pt,mirror}] (G0-|C0) --
node[right=20pt] {$x^{(2)}_j = y^{(1)}_j$} (G7-|C0);
...
\draw[decorate,decoration={brace,raise=75pt,mirror}] (B0-|C) --
node[right=80pt] {Convolutional\\ layer} (G7-|C0);

\draw[decorate,decoration={brace,raise=95pt,mirror}] (G0-|C0) --
node[right=100pt] {Deconvolutional\\ layer} (C);
