...
\begin{itemize}
\item Add definitions of TPR, PPV, and DSC and a short intuition what they
measure.
...
\caption{Comparison of segmentation accuracy measured by the DSC of a 3-layer
CEN and a 7-layer CEN for different lesion load categories. The 7-layer CEN
improves the performance across all lesion sizes compared to the 3-layer CEN,
where the improvements are especially large for large lesion loads and lesion
size.}
\end{figure}
...
\caption{Comparison of segmentation accuracy measured by the DSC of lesionTOADS
and a 7-layer CEN for different lesion loads. The CEN approach is much more
sensitive in detecting small lesions, while still being able to detect large
lesions.}
\end{figure}
